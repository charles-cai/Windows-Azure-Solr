...
namespace SolrMasterHostWorkerRole
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            _port = RoleEnvironment.CurrentRoleInstance.InstanceEndpoints["SolrMasterEndpoint"].IPEndpoint.Port.ToString();
            _mySolrUrl = string.Format("http://{0}/solr/", RoleEnvironment.CurrentRoleInstance.InstanceEndpoints["SolrMasterEndpoint"].IPEndpoint);
